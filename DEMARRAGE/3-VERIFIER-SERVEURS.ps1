# ================================================================
# PLAN B - VÉRIFICATION DES SERVEURS
# ================================================================
# Ce script vérifie l'état de tous les serveurs
# ================================================================
...
# ================================================================
Write-Host "[1/3] Vérification PostgreSQL..." -ForegroundColor Yellow
...
# ================================================================
Write-Host "[2/3] Vérification Backend..." -ForegroundColor Yellow
...
if ($phpProcess) {
    ...
    Write-Host "       Lancez: .\DEMARRAGE\1-DEMARRER-TOUT.ps1" -ForegroundColor Yellow
}
Write-Host ""
...
# ================================================================
Write-Host "[3/3] Vérification Frontend..." -ForegroundColor Yellow
...
if ($allRunning) {
    ...
    Write-Host ""
    Write-Host "  Pour demarrer: .\DEMARRAGE\1-DEMARRER-TOUT.ps1" -ForegroundColor Cyan
}
Write-Host ""
