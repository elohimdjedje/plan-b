...
/**
 * Initialiser les annonces de démo (ne fait rien en production)
 * Cette fonction existe pour la compatibilité mais ne fait rien
 * car on utilise les vraies données du backend
 * @returns {Promise<void>}
 */
export const initializeDemoListings = async () => {
  // Ne fait rien en production - on utilise les vraies données
  return Promise.resolve();
};
