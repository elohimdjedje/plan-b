          ...
          >
            ...
            {step === 3 && (
              <GlassCard>
                ...
                {/* Visite Virtuelle 360° - PRO uniquement */}
                {(accountType === 'PRO' || user?.isLifetimePro) && (
                  <div className="mt-6 pt-6 border-t border-secondary-200">
                    ...
                    <div className="mt-3 bg-blue-50 p-3 rounded-lg text-sm text-blue-700">
                      <p className="font-medium mb-1">💡 Comment créer une photo 360° ?</p>
                      <ul className="list-disc list-inside space-y-1 text-xs">
                        <li>Utilisez l'app <strong>Google Street View</strong> (gratuit)</li>
                        <li>Ou <strong>Cardboard Camera</strong> (gratuit)</li>
                        <li>Format équirectangulaire requis (ratio 2:1)</li>
                      </ul>
                    </div>
                  </div>
                )}
