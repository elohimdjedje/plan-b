...
import { Settings, Heart, LogOut, Crown, TrendingUp, Eye, MoreVertical, Trash2, Calendar, Edit, CheckCircle2, RefreshCw, Home, Key, Star, Shield, BookOpen } from 'lucide-react';
        ...
        <GlassCard>
          ...
          <div className="grid grid-cols-3 gap-3">
            <button
              ...
              className="flex items-center gap-3 p-4 bg-gradient-to-br from-orange-500/10 to-orange-600/10 hover:from-orange-500/20 hover:to-orange-600/20 rounded-xl border border-orange-500/20 transition-all group"
            >
              ...
              <div className="text-left">
                <div className="font-semibold text-secondary-900">Mes réservations</div>
                <div className="text-xs text-secondary-600">Gérer mes locations</div>
              </div>
            </button>
            <button
              onClick={() => navigate('/favorites')}
              className="flex items-center gap-3 p-4 bg-gradient-to-br from-red-500/10 to-pink-600/10 hover:from-red-500/20 hover:to-pink-600/20 rounded-xl border border-red-500/20 transition-all group"
            >
              ...
              <div className="text-left">
                <div className="font-semibold text-secondary-900">Favoris</div>
                <div className="text-xs text-secondary-600">Mes annonces sauvegardées</div>
              </div>
            </button>
            <button
              onClick={() => navigate('/availability')}
              className="flex items-center gap-3 p-4 bg-gradient-to-br from-blue-500/10 to-cyan-600/10 hover:from-blue-500/20 hover:to-cyan-600/20 rounded-xl border border-blue-500/20 transition-all group"
            >
              <div className="w-10 h-10 bg-blue-500 rounded-lg flex items-center justify-center group-hover:scale-110 transition-transform">
                <Calendar className="w-5 h-5 text-white" />
              </div>
              <div className="text-left">
                <div className="font-semibold text-secondary-900">Disponibilités</div>
                <div className="text-xs text-secondary-600">Créneaux de visite</div>
              </div>
            </button>
          </div>
        </GlassCard>
