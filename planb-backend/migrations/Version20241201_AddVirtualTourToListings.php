...
final class Version20241201_AddVirtualTourToListings extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE listings ADD COLUMN virtual_tour_data JSONB DEFAULT NULL');
        
        // Créer un index pour améliorer les performances
        $this->addSql('CREATE INDEX idx_listing_virtual_tour ON listings(virtual_tour_type) WHERE virtual_tour_type IS NOT NULL');
    }

    public function down(Schema $schema): void
    {
        // Supprimer l'index
        $this->addSql('DROP INDEX IF EXISTS idx_listing_virtual_tour');
